                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <div class="form-floating mb-3">
                                <Editor api-key="7qjkjvz7eegr5schf3b8iwvemcxjb82zvn5nvbm02u8l4xkb" :init="{
                                    ...
                                    v-model="post.description" style="height: 200px;"></Editor>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-floating mb-3">
                                <img :src="post.thumbnailUrl == null ? defaultThumbnailUrl : imageBaseUrl + post.thumbnailUrl"
...
const defaultThumbnailUrl = 'https://images.unsplash.com/photo-1647891937869-bc31fe3f9836?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80';
let imageBaseUrl = 'http://localhost:5008/uploads/post/';
...
onMounted(async () => {
    const categoryResponse = await axiosTokenInstance.get('/category/get');
    categories.value = categoryResponse.data;

    const postResponse = await axiosTokenInstance.get('/post/get/' + id);
    post.value = postResponse.data;

    post.value.categoryIds = post.value.categories.map((category) => {
        return category.id;
    });
...
const onSubmit = async () => {
    ...
    const response = await axiosTokenInstance.put('/post/edit/' + id, formData);
